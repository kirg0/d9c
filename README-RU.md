...
<p align="center">
  <img src="docs/demo.gif" alt="Демо d9c: список контейнеров, живые CPU/MEM, фильтр, логи, другие разделы и справка" width="900">
</p>
...
Если установлен [Go 1.25+](https://go.dev/dl/):

```sh
go install github.com/kirg0/d9c@latest   # бинарник появится в $(go env GOPATH)/bin
```
...
```yaml
lang: en                  # язык интерфейса: en (по умолчанию) или ru
...
(`lang:`) и переживает перезапуск. По умолчанию интерфейс английский (`lang: ru` в конфиге — русский).
